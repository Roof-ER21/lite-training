...
const FINAL_EXAM_MCQ: MCQQuestion[] = [
  ...
  { id: 'mcq-5', module: 2, question: 'According to Roof E.R.\'s values, what does "Integrity" mean?', options: ['Having the courage to be honest with yourself and always doing what\'s right', 'Following company policies', 'Maximizing sales numbers', 'Being faster than competitors'], correctAnswer: 0, explanation: 'Integrity means having the courage to be honest with yourself first, then being honest, not lying, cheating, or stealing - always doing what\'s right for the homeowner.' },

  // Module 4: Shingle Types & Materials (3 MCQ)
  { id: 'mcq-6', module: 4, question: 'Which statement best describes the GAF Timberline HDZ shingle we upgrade customers to?', options: ['A basic 3-tab shingle with a 60 mph wind rating', 'A metal panel system used on low-slope roofs', 'An architectural shingle with a reinforced nailing zone and strong wind rating', 'A clay tile designed for custom homes'], correctAnswer: 2, explanation: 'Timberline HDZ is an architectural shingle with a reinforced nailing zone and strong wind performance.' },
  { id: 'mcq-7', module: 4, question: 'Which shingle type is most commonly used in residential roofing?', options: ['Asphalt', 'Metal shingles', 'Clay tiles', 'Slate'], correctAnswer: 0, explanation: 'Asphalt shingles are the most common residential roofing material.' },
  ...
  { id: 'mcq-30', module: 11, question: 'What is the "Assumptive Close"?', options: ['Assuming they won\'t buy', 'Assuming the insurance will deny', 'Acting as if they\'ve already agreed and moving to next steps', 'Guessing their concerns'], correctAnswer: 2, explanation: 'Assumptive close: proceed as if they\'ve said yes - "I\'ll get that contract texted to you now."' },
  { id: 'mcq-31', module: 11, question: 'The homeowner says "I want to get other quotes." Best response?', options: ['Fine, get 10 quotes', 'Lower your price immediately', 'Explain you\'re a claims specialist, not just a roofer, and what sets you apart', 'Criticize other companies'], correctAnswer: 2, explanation: 'Differentiate by explaining you\'re a claims specialist who handles insurance, not just a roofer.' },
