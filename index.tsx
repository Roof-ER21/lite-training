...
const FINAL_EXAM_MCQ: MCQQuestion[] = [
  ...
  { id: 'mcq-4', module: 4, question: 'What is the warranty offered for the shingle that we upgrade our customers to (GAF Timberline HDZ)?', options: ['10 years', '25-30 years', 'Limited lifetime warranty', '50 years'], correctAnswer: 2, explanation: 'The GAF Timberline HDZ shingle comes with a limited lifetime warranty.' },
