...
const FINAL_EXAM_MCQ: MCQQuestion[] = [
  ...
  { id: 'mcq-5', module: 2, question: 'According to Roof E.R.\'s values, what does "Integrity" mean?', options: ['Following company policies', 'Having the courage to be honest with yourself and always doing what\'s right', 'Maximizing sales numbers', 'Being faster than competitors'], correctAnswer: 1, explanation: 'Integrity means having the courage to be honest with yourself first, then being honest, not lying, cheating, or stealing - always doing what\'s right for the homeowner.' },
  ...
  { id: 'mcq-27', module: 11, question: 'When is the best time for your customer to file a claim?', options: ['Within a week', 'Same day - immediately', 'After getting other estimates', 'After the adjuster visits'], correctAnswer: 1, explanation: 'File the claim the same day, immediately after finding damage - timing is critical for insurance claims.' },
